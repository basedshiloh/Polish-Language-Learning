...
export default function GrammarCard({ topic }: { topic: GrammarTopic }) {
  ...
  return (
    <Link
      ...
      className="group bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 hover:border-purple-200 dark:hover:border-purple-800 hover:shadow-md transition-all flex flex-col"
    >
