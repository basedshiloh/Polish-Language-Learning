  ...
  return (
    <>
      ...
      {mounted && createPortal(
        <>
          {/* Overlay — fades in/out, click to close */}
          <div
          ...
          <aside
            className={`fixed top-0 right-0 z-[60] h-screen w-72 max-w-[80%] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 shadow-2xl md:hidden transition-transform duration-300 ease-out ${
