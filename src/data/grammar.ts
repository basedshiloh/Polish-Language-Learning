  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          headers: ['', 'Singular ending', 'Example', 'Question'],
          columnColors: [null, 'green', null, 'purple'],
          highlightFirstCol: true,
          rows: [
      ...
      {
        type: 'table',
        title: 'Instrumental Plural — nouns and adjectives',
        table: {
          caption: 'In the plural, nouns take -ami and adjectives take -ymi/-imi:',
          headers: ['Singular (Instr.)', 'Plural (Instr.)', 'With adjective'],
          rows: [
            ['studentem', 'studentami', 'dobrymi studentami'],
            ['studentką', 'studentkami', 'ambitnymi studentkami'],
            ['krzesłem', 'krzesłami', 'starymi krzesłami'],
            ['Amerykaninem', 'Amerykanami', 'wysokimi Amerykanami'],
            ['Indonezyjką', 'Indonezyjkami', 'sympatycznymi Indonezyjkami'],
            ['samochodem', 'samochodami', 'japońskimi samochodami'],
            ['miastem', 'miastami', 'rosyjskimi miastami'],
          ],
          footnote: 'Noun plural: -ami. Adjective plural: -ymi (after k,g → -imi). Irregulars: dziećmi, ludźmi, przyjaciółmi.',
        },
      },
      {
        type: 'table',
        title: '"Z" (with) + Instrumental — Food & Companions',
        table: {
          caption: 'The preposition "z" (with) always triggers the instrumental case:',
          headers: ['Polish', 'English', 'What changed?'],
          rows: [
            ['kawa z mlekiem', 'coffee with milk', 'mleko → mlekiem'],
            ['herbata z cukrem', 'tea with sugar', 'cukier → cukrem'],
            ['herbata z miodem', 'tea with honey', 'miód → miodem'],
            ['chleb z masłem', 'bread with butter', 'masło → masłem'],
            ['chleb z szynką', 'bread with ham', 'szynka → szynką'],
            ['kurczak z ziemniakami', 'chicken with potatoes', 'ziemniaki → ziemniakami (pl.)'],
            ['kotlet z frytkami', 'cutlet with fries', 'frytki → frytkami (pl.)'],
            ['z keczupem', 'with ketchup', 'keczup → keczupem'],
            ['z musztardą', 'with mustard', 'musztarda → musztardą'],
            ['Spotykam się z kolegą.', 'I meet with a colleague.', 'kolega → kolegą'],
            ['Idę z przyjaciółmi.', 'I go with friends.', 'przyjaciele → przyjaciółmi (irreg.)'],
          ],
        },
      },
      {
        type: 'table',
        title: 'Transport — Czym jedziesz?',
        table: {
          caption: 'Vehicles go directly into the instrumental, no preposition needed:',
          headers: ['Nominative', 'Instrumental', 'Sentence'],
          highlightFirstCol: true,
          rows: [
            ['autobus', 'autobusem', 'Jadę autobusem.'],
            ['samochód', 'samochodem', 'Jadę samochodem.'],
            ['pociąg', 'pociągiem', 'Jadę pociągiem.'],
            ['tramwaj', 'tramwajem', 'Jadę tramwajem.'],
            ['rower', 'rowerem', 'Jadę rowerem.'],
            ['metro', 'metrem', 'Jadę metrem.'],
            ['taksówka', 'taksówką', 'Jadę taksówką.'],
            ['hulajnoga', 'hulajnogą', 'Jadę hulajnogą.'],
          ],
        },
      },
      {
        type: 'examples',
        title: 'The five main uses — summary',
        examples: [
          { polish: 'Jestem nauczycielem.', english: 'I am a teacher.', note: 'być + profession' },
          { polish: 'On jest inteligentnym studentem.', english: 'He is an intelligent student.', note: 'być + adj + profession' },
          { polish: 'Interesuję się sportem.', english: 'I\'m interested in sport.', note: 'interesować się + instr.' },
          ...
          { polish: 'Poproszę kawę z mlekiem.', english: "I'd like coffee with milk.", note: '"z" = with (food)' },
        ],
      },
      {
        type: 'note',
        noteType: 'tip',
        note: 'Quick cheat sheet:\nNoun: M/N → -em (-iem after k/g) | F → -ą | Plural → -ami\nAdj:  M/N → -ym (-im after k/g) | F → -ą | Plural → -ymi (-imi after k/g)',
      },
    ],
  },
