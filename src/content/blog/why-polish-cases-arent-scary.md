...
|------|---------------------|-----------------------|
| Nominative | kot | dom |
| Accusative | kot**a** | dom (no change) |
| Instrumental | kot**em** | dom**em** |
| Genitive | kot**a** | dom**u** |
...
| Accusative | mam**ę** | książk**ę** |
| Instrumental | mam**ą** | książk**ą** |
| Genitive | mam**y** | książk**i** |
...
| Instrumental | okn**em** | morz**em** |
| Genitive | okn**a** | morz**a** |
...
1. **Mama** gotuje obiad. (Nominative — Mom is the subject)
2. Mama gotuje **zupę**. (Accusative — soup is the object being cooked)
3. Mama gotuje z **tatą**. (Instrumental — with Dad)
4. To jest przepis **mamy**. (Genitive — Mom's recipe)
