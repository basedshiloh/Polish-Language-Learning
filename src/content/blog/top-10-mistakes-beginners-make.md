...
- Right: *To jest dobr**a** książka.* — This is a good book.
...
- Right: *Ja mówi**ę** po polsku.* — I speak Polish.
...
- Right: *Lubię polsk**ą** muzyk**ę**.* — I like Polish music.
...
1. **Gender** — learn it with every new noun
2. **Accusative case** — master this one case first
3. **Pronunciation of w/ł** — retrain these two sounds early
