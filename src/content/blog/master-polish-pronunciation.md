...
> **Key rule:** Stress in Polish almost always falls on the second-to-last syllable. *Dzi-ę-ku-**ję*** (thank you), *war-**sza**-wa* (Warsaw), *u-ni-wer-sy-**te**-cie* (at the university).
...
- Examples: **sz**koła (school), pro**sz**ę (please), du**sz**a (soul)
...
- Examples: **cz**as (time), klu**cz** (key), **cz**eko-lada (chocolate)
...
- **rz** appears after consonants: p**rz**ed (before), d**rz**wi (door), t**rz**y (three)
- **ż** appears elsewhere: **ż**aba (frog), mą**ż** (husband), mo**ż**e (maybe)
...
- Examples: **ś**nieg (snow), pro**ś**ba (request), je**ś**li (if)

### ć — a soft "ch"

- Similar to: a light, quick "ch" — like the "t" in British "tune"
- Examples: **ć**ma (moth), no**ć** (night), ko**ć** (bone)

### ź — a soft "zh"

- Similar to: a light version of ż
- Examples: **ź**rebak (foal), gwo**ź**dź (nail)

### dź — a soft "j"

- Similar to: a light "j" sound, like the "d" in British "dune"
- Examples: **dź**wig (crane), dź**w**ięk (sound)

> **Important:** Before the vowel **i**, the letters s, c, z, and dz are automatically pronounced as ś, ć, ź, and dź. So *siano* (hay) sounds like "**ś**ano" and *ciasto* (cake) sounds like "**ć**asto." You don't need the accent mark when **i** follows!
...
- Examples: m**ą**ż (husband), s**ą**d (court), r**ą**ka (hand — Nominative: ręka shifts to ą in some forms)
- Before b/p: sounds like "om" — z**ą**b (tooth) → "zomp"
- Before d/t: sounds like "on" — k**ą**t (corner) → "kont"
- Before g/k: sounds like "ong" — m**ą**ka (flour) → "mong-ka"

### ę — nasal "e"

- Sounds like: "en" with a nasal buzz, or French "in"
- Examples: r**ę**ka (hand), pi**ę**ć (five), j**ę**zyk (language)
...
|---------|--------------|---------|
| b → p | chleb → "chlep" | (bread) |
| d → t | kod → "kot" | (code) |
| g → k | Bug → "Buk" | (Bug river) |
| w → f | krew → "kref" | (blood) |
| z → s | mróz → "mrus" | (frost) |
| ż/rz → sz | mąż → "monsz" | (husband) |
